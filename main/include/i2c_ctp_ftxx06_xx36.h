...
#define CTP_FTxxxx_TICKS_TO_WAIT (pdMS_TO_TICKS(10)) // I2C读写的超时等待时间

#define CTP_FTxxxx_SLAVE_ADDRESS                                                                   \
    0x38 // FTxxxx在I2C总线上的从机器件地址(敦泰的触摸控制IC，型号包括：FT5206、FT5336、FT5436、FT6206、FT6236)
