    ...
    lv_obj_set_scroll_dir(obj, LV_DIR_VER);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_BOTTOM, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // main_page_weather_uptime_1
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    objects.main_page_weather_uptime_1 = obj;
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_obj_set_style_text_font(obj, ui_font_source_han_sans_sc_14, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void delete_screen_weather() {
    ...
    objects.weather = 0;
    objects.obj10 = 0;
    objects.main_page_weather_uptime_1 = 0;
    objects.obj11 = 0;
    objects.obj12 = 0;
    objects.obj13 = 0;
    objects.obj34 = 0;
...
void tick_screen_weather() {
    ...
    (void)flowState;
    {
        ...
        const char *cur_val = lv_label_get_text(objects.main_page_weather_uptime_1);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.main_page_weather_uptime_1;
            lv_label_set_text(objects.main_page_weather_uptime_1, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
...
static const char *screen_names[] = { "Main", "Menu", "Weather" };
static const char *object_names[] = { "main", "menu", "weather", "obj0", "obj0__obj0", "obj0__obj1", "obj1", "obj2", "obj3", "obj4", "obj5", "obj6", "main_page_weather_icon", "main_page_weather_temp", "main_page_weather_uptime", "main_page_weather_text", "obj7", "main_page_lunar", "obj8", "obj9", "obj10", "main_page_weather_uptime_1", "obj11", "obj12", "obj13", "obj14", "obj15", "obj16", "obj17", "obj18", "obj19", "obj20", "obj21", "obj22", "obj23", "obj24", "obj25", "obj26", "obj27", "obj28", "obj29", "obj30", "obj31", "obj32", "obj33", "obj34" };
